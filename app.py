...
def predict_result():
    ...
    city_names = {
        '0': 'Ahmedabad', '1': 'Bengaluru', '2': 'Chennai', '3': 'Coimbatore', '4': 'Delhi', '5': 'Ghaziabad',
        '6': 'Hyderabad', '7': 'Indore', '8': 'Jaipur', '9': 'Kanpur', '10': 'Kochi', '11': 'Kolkata',
        '12': 'Kozhikode', '13': 'Lucknow', '14': 'Mumbai', '15': 'Nagpur', '16': 'Patna', '17': 'Pune', '18': 'Surat'
    }
    ...
    if not city_code or not crime_code or not year:
        return render_template('index.html', error="⚠️ Please select City, Crime Type, and Year before predicting!")

    pop = population[city_code]

    # Adjusting population with 1% growth per year after 2011
